      ...
      children: [
        ...
        SettingsTile(
          ...
          trailing: Switch(
            ...
            onChanged: (value) {
              settingsNotifier.updateConfetti(value);
            },
          ),
        ),
      ],
    ...
    return SettingsSection(
      ...
      children: [
        ...
        SettingsTile(
          ...
          subtitle: 'Partager le résumé 2026',
          onTap: () async {
            final yearStats = await ref.read(yearSummaryProvider(2026).future);
            if (yearStats != null) {
        ...
        SettingsTile(
          ...
          onTap: () async {
            ...
            if (export != null) {
              ...
              if (json != null) {
                await Share.share(json, subject: 'Export Year in Colors 2026');
              }
            }
          },
        ),
