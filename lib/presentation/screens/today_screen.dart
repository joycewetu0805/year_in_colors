...
class _TodayScreenState extends ConsumerState<TodayScreen> {
  ...
  String _getRelativeDateText(DateTime date) {
    ...
    return app_date.AppDateUtils.formatDayMonthYear(date);
  }
            ...
            children: [
              ...
              FadeAnimation(
                child: Column(
                  children: [
                    Text(
                      app_date.AppDateUtils.formatDayMonthYear(_selectedDate),
                    ...
                    Text(
                      app_date.AppDateUtils.getDayName(_selectedDate),
  ...
  Widget _buildDateNavigation() {
    final isToday = app_date.AppDateUtils.isToday(_selectedDate);
